...
parser.add_argument("--ft", type=int, default=0) #number of layers to finetune; 1, 2 or 3 layers 
...
train_dir = os.path.join('C:', 'Users', 'aldob', 'Desktop', 'Tesi', 'task5', 'Dataset', 'Dataset', 'Development_Set', 'Training_Set')
val_dir = os.path.join('C:', 'Users', 'aldob', 'Desktop', 'Tesi', 'task5', 'Dataset', 'Dataset', 'Development_Set', 'Validation_Set')

#parser.add_argument("--traindir", type=str, default=train_dir)
#parser.add_argument("--valdir", type=str, default=val_dir)
parser.add_argument("--traindir", type=str, default='E:/Tesi/Development_Set/Training_Set/Audios') #root dir for the training dataset
parser.add_argument("--valdir", type=str, default='E:/Tesi/Development_Set/Validation_Set') #root dir for the validation dataset
parser.add_argument("--train_json", type=str, default='C:/Users/aldob/Documents/GitHub/Thesis/Codice_Tesi/Json_files/train_data.json') 
parser.add_argument("--val_json", type=str, default='C:/Users/aldob/Documents/GitHub/Thesis/Codice_Tesi/Json_files/val_data.json') 
