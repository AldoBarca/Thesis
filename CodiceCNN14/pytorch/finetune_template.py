...
class Transfer_Cnn14(nn.Module):
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, 
        ...
        self.fc_transfer = nn.Linear(2048, classes_num, bias=True)  #va capito se va bene proiettare l'embedding da 527 a 2048.
...
def train_task(n_epoche,model,optimizer,criterion):
    print("ciao")
    audio_path="E:/Tesi/Development_Set/Training_Set/HT/a1.wav"
